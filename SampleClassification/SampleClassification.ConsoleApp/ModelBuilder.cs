...
namespace SampleClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/Users/aliniyor/Desktop/mlNetConsole/myMLApp/data.txt";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.AveragedPerceptron(new AveragedPerceptronTrainer.Options() { LearningRate = 0.1f, DecreaseLearningRate = false, L2Regularization = 0.15364508f, NumberOfIterations = 9, InitialWeightsDiameter = 0.78283334f, Shuffle = true, LabelColumnName = "col1", FeatureColumnName = "Features" }), labelColumnName: "col1")
